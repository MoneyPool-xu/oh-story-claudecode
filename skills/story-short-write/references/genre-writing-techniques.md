...
1. **阶梯式背叛**：让背叛在类别、代价或关系后果上升级（道德→经济→生命）；相关揭露可在同一证据链汇合，不按章配额
2. **冷热对比法**：用筹码、选择和行动后果形成反差；角色情绪服从现场，不强制主角冷、对方歇斯底里
3. **双面人剥皮术**：先写表面好，再层层剥开真相（复制粘贴的关心模板）
4. **前世记忆穿插法**：只在前世记忆会改变当下判断、选择或信息时穿插，不按章配回忆
5. **审判式对话**：只在提问能迫使对方选择、暴露矛盾或改变关系时使用；没有筹码的连续审问会变成模板

### 结构创新技法

1. **短章推进**：小节通常偏短，长度服从完整动作链；让爆点、选择、信息或后果持续前推，不设逐章字数和爆点配额
...
对白占比只作同题材、同平台样本的观察数据，不设全文通过阈值。对白驱动场景可以密，核验证据、手艺、等待、悬疑观察等场景可以少或没有对白。
...
| 对白服从场景功能 | 改变信息、策略、权力、关系或行动 | 为抬高占比补问答、复述或无效狠话 |
| 段落服从戏剧单元 | 一件事、一个镜头或一条推理链完成再断段 | 按句数强拆，形成提纲体或电报体 |
| 情绪词后接具体动作 | 直写情绪成语，后面接一个场景里的具体动作或物件（见 short-craft 第2节），只删后面接不上具体东西的情绪总结句 | 《为给白月光出气，男友群发我私密照》我紧紧抿着嘴唇，直到尝到血腥味 |
| 场景产生真实变化 | 改变风险、信息、关系、资源、决定、行动或读者理解之一 | 为凑多功能添加旁人反应、回忆或独立障碍 |
| 结尾用动作/对话 | 不升华、不总结、不感慨 | "从此以后她明白了..." |
| 主角有辨识度 | 冷静落在取证、选择、延迟回应或资源调度上；用本篇独有的动作，不套通用标志 | 端水杯、整理西装、转笔等通用动作当必备项，或全篇无辨识度 |
| 信息与后果持续前推 | 新信息、行动、关系变化、局部兑现或后果均可承接 | 为逐章达标另造信息炸弹 |
...
### 视角数量控制
- 视角按亲密度与信息差选择：受害者第一人称适合强主观亲历，第三人称限知适合需要距离或并行场景；他人视角只有在交付主视角无法提供的新因果时才切换，不平分篇幅
...
- [ ] 每个场景都改变了风险、信息、关系、资源、决定、行动或读者理解之一？
